...
public class ChatView extends VerticalLayout {
    ...
    private void createChatForm() {
        ...
        progressBar.setIndeterminate(true); // Show an indeterminate progress state
        ...
        input.addSubmitListener(submitEvent -> {
            ...
            CompletableFuture.supplyAsync(() -> openAIService.sendMessage(userMessageText))
                    ...
                    .exceptionally(ex -> {
                        ...
                        ex.printStackTrace();
                        currentUI.access(() -> progressBar.setVisible(false)); // Hide progress bar on error
                        return null;
                    });
